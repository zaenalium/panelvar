...
RcppExport SEXP _panelvar_cg_cpp(SEXP ASEXP, SEXP bSEXP, SEXP BSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _panelvar_mmult(SEXP m1SEXP, SEXP m2SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_panelvar_cg_cpp", (DL_FUNC) &_panelvar_cg_cpp, 3},
    {"_panelvar_mmult", (DL_FUNC) &_panelvar_mmult, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_panelvar(DllInfo *dll) {
